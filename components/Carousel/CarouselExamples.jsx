...
const CarouselExamples = () => (
  ...
  <div className="CarouselExamples">
    ...
    <div className="limited-width">
      <Carousel>
        <StandardListItem labelText="Community" imgSrc={require('-!file!./placeholder.svg')} />
        <StandardListItem labelText="Compete" imgSrc={require('-!file!./placeholder.svg')} />
        <StandardListItem labelText="Learn" imgSrc={require('-!file!./placeholder.svg')} />
      </Carousel>
    </div>
    <p>With full width</p>
